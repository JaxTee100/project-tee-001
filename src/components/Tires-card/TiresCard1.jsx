...
const TiresCard1 = () => {
  return (
    <div className='w-[350px] md:w-[336px] lg:w-[490.67px] h-[338px] border   flex flex-col justify-between gap-[20px] pt-[12px] lg:pt-[24px]  shadow-md rounded-[24px] relative overflow-hidden'>
        <div className='w-[350px] lg:w-[490.67px] h-[35px] lg:h-[45px] px-[32px] py-[6px] mt-[-12px] lg:mt-[-24px] flex items-center justify-center bg-[#e2e8f0]'>
            Spring Care Event
        </div>
                                                                                                          {/* pass as a prop  */}
        <div className='w-[110px] h-[30px] flex justify-center items-center absolute top-[12px] left-[-29px] bg-[#f7ba82] -rotate-45'>
            <p className='mr-[5px]'>Good</p>
            <IoMdRibbon />

        </div>
      <div className='w-[350px] md:w-[336px] lg:w-[426.67px] lg:ml-[30px]  lg:justify-between h-[46px]  p-[8px]  flex gap-[16px] items-start lg:items-center'>
      ...
      <button className='w-[350px] md:w-[336px] lg:w-[490.67px] h-[82px] lg:h-[61px] p-[16px] flex gap-[auto] justify-between bg-[#1e293b] text-white'>
