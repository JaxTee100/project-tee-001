...
const AccessoriesCard = ({Img}) => {
  return (
    <div className='w-[358px] md:w-[336px] lg:w-[490.67px] h-[200px] lg:h-[252px] border  rounded-[24px] flex flex-col justify-between overflow-hidden active:border active:border-[black] '>
      {/* #e2e8f0 */}
      <div className='flex items-center lg:w-[490.67px]  h-[147px] lg:h-[196px] gap-[24px] p-[16px]'>
        ...
        <div className=' w-[165px] lg:w-[270px] h-[92px] lg:h-[109px] text-[#1e293b]'>
            <h1 className='font-semibold text-[16px] lg:text-[25px] '>Engine Block Heater</h1>
            <div className='mb-[10px] lg:mb-[14px]'>
              <span className='font-regular text-[14px]'>Installation: </span>
