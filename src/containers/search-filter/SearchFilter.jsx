...
const SearchFilter = () => {
  ...
  return (
    <div className='h-[497px] lg:h-[106px] lg:w-[1491px] rounded lg:rounded-[80px] border bg-white p-[24px] lg:px-[24px] lg:py-[20px] flex flex-col lg:flex-row lg:justify-start gap-[24px] lg:mx-auto shadow-md'>
